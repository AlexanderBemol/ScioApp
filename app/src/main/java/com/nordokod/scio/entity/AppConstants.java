...
public class AppConstants {
    ...
    public static final String CLOUD_USERS="Users";
    public static final String CLOUD_EDUCATIONAL_LEVEL="EducationalLevel";
    public static final String CLOUD_PROFILE_PHOTO="ProfilePhotos";
    ...
    public static final String CLOUD_CATEGORYS="Categorys";
