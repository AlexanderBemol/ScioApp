...
import com.nordokod.scio.old.model.Question;
        ...
        BTN_Create.setOnClickListener(v -> {
            ...
            if (preview_answer > 0) {
                if(Objects.requireNonNull(ET_Question.getText()).length()>0){
                    TrueFalseQuestion trueFalseQuestion = new TrueFalseQuestion(guide.getId(),0, Objects.requireNonNull(ET_Question.getText().toString()), KindOfQuestion.TRUE_FALSE.getCode(), answer);
